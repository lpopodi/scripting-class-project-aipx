<?php
# PHPFMG_ID:'20130910-122f'
# Date : 20130910 00:58:37
...
define( 'PHPFMG_TO' , 'lpopodi@decibel-media.com' );
define( 'PHPFMG_REDIRECT', '' ); 

define( 'PHPFMG_ID' , '20130910-122f' ); 
...
define( 'PHPFMG_SUBJECT' , "Schedule Consultation" );
define( 'PHPFMG_CC' , '' );
define( 'PHPFMG_BCC', '' );
...
$GLOBALS['form_mail']['field_0'] = array( "name" => "field_0", "text" => "First Name",  "type" => "senderfirstname", "instruction" => "Type First Name Here", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_1'] = array( "name" => "field_1", "text" => "Last Name",  "type" => "senderlastname", "instruction" => "Type Last Name Here", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_2'] = array( "name" => "field_2", "text" => "Email",  "type" => "sender's email", "instruction" => "Enter your email address", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_3'] = array( "name" => "field_3", "text" => "Phone",  "type" => "text", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_4'] = array( "name" => "field_4", "text" => "City",  "type" => "text", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_5'] = array( "name" => "field_5", "text" => "State",  "type" => "text", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_6'] = array( "name" => "field_6", "text" => "Zip",  "type" => "text", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_7'] = array( "name" => "field_7", "text" => "Service Request",  "type" => "select", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_8'] = array( "name" => "field_8", "text" => "How did you hear about us?",  "type" => "select", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_9'] = array( "name" => "field_9", "text" => "Comments",  "type" => "textarea", "instruction" => "", "required" => "" ) ;
...
function phpfmg_formini(){
    return "";
}
